...
public class UserAdidasAdapter extends BaseAdapter {
    Context context ;
    ArrayList<sanpham> arrayAdidas ;

    public UserAdidasAdapter(Context context, ArrayList<sanpham> arrayAdidas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.dong_sanphamadidasuser,null);
            viewholder.textViewtenAdidas = convertView.findViewById(R.id.txttenspAdidasuser);
            viewholder.textViewgiaAdidas = convertView.findViewById(R.id.txtgiaspAdidasuser);
            viewholder.imgAdidas = convertView.findViewById(R.id.imgsanphamAdidasuser);
